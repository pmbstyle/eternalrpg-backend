...
export default {
    ...
    mounted: async function() { 
        await this.getNewsPost(this.$route.params.id)
        this.setNewsPost(this.news.post)
    },
	methods: {
		...mapActions(['getNewsPost','updateNewsPost']),
        setNewsPost: function(){
            this.post.image = this.news.post.image
            this.post.title_en = this.news.post.title_en
            this.post.title_ru = this.news.post.title_ru
            this.post.slug = this.news.post.slug
            this.post.description_en = this.news.post.description_en
            this.post.description_ru = this.news.post.description_ru
            this.post.full_text_en = this.news.post.full_text_en
            this.post.full_text_ru = this.news.post.full_text_ru
        },
        ...
        verifyData: async function() {
            ...
            if(!this.hasErrors) {
                ...
                let status = await this.updateNewsPost(this.post)
                if(status) {
